...
///////////////////////////////////////////////////////////////////////////////
// 2009-01-30 by cmkwon, 러시아 Innova 런처 시스템(프로스트) 수정 - 헤더파일 추가
// 2009-04-23 by cmkwon, 러시아 Innova Frost 임시 제거하기 - 아래와 같이 define 으로 처리 함.
...
//#include "SharedMemory.h"					// 2009-01-30 by cmkwon, 러시아 Innova 런처 시스템(프로스트) 수정 - 
//#include "ShieldSecurity.h"					// 2009-01-30 by cmkwon, 러시아 Innova 런처 시스템(프로스트) 수정 - 
///////////////////////////////////////////////////////////////////////////////
// 2009-07-10 by cmkwon, 러시아 Frost 신규 Lib로 수정 - 
...
// 2007-09-07 by cmkwon, 베트남 런처 인터페이스 수정 - 주석처리함
...
// 2008-04-25 by cmkwon, 지원 언어/서비스 추가시 꼭 추가 되어야 하는 사항 - [서비스-필수] 런처 Interface 위치 정의 하기
...
// 2007-09-07 by cmkwon, 베트남 런처 인터페이스 수정 -
	...
	#define EXE2_BG_TITLE_BAR_SIZE_Y				27						// 타이틀바 Height
	...
	#define EXE2_BG_WEBCONTROL_POS_X				235		// 웹브라우저 컨트롤 위치 X
	#define EXE2_BG_WEBCONTROL_POS_Y				73		// 웹브라우저 컨트롤 위치 Y
	#define EXE2_BG_WEBCONTROL_WIDTH				544		// 웹브라우저 컨트롤 Width
	#define EXE2_BG_WEBCONTROL_HEIGHT				480		// 웹브라우저 컨트롤 Height

	#define EXE2_BG_RESOLUTION_COMBOBOX_POS_X		17		// 해상도 선택 Combo Box 위치 X
	#define EXE2_BG_RESOLUTION_COMBOBOX_POS_Y		529		// 해상도 선택 Combo Box 위치 Y
	#define EXE2_BG_RESOLUTION_COMBOBOX_WIDTH		194		// 해상도 선택 Combo Box Width
	#define EXE2_BG_RESOLUTION_COMBOBOX_HEIGHT		16		// 해상도 선택 Combo Box Height

	#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_X		118		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 X
	#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_Y		512		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 Y
	...
	#define EXE2_BG_ACCOUNTNAME_EDIT_POS_X			94		// AccountName Edit Box 위치 X
	#define EXE2_BG_ACCOUNTNAME_EDIT_POS_Y			421		// AccountName Edit Box 위치 Y
	...
	#define EXE2_BG_PASSWORD_EDIT_POS_X				94		// Password Edit Box 위치 X
	#define EXE2_BG_PASSWORD_EDIT_POS_Y				440		// Password Edit Box 위치 Y
	...
	#define EXE2_BG_SERVERLIST_BOX_POS_X			42		// ServerList Box 위치 X
	#define EXE2_BG_SERVERLIST_BOX_POS_Y			166		// ServerList Box 위치 Y
	...
	#define EXE2_BG_SERVERLIST_ITEM_ICON_POS_X		0		// ServerList Item Icon 위치 X
	#define EXE2_BG_SERVERLIST_ITEM_ICON_POS_Y		0		// ServerList Item Icon 위치 Y
	...
	#define EXE2_BG_MINIMIZED_BTN_POS_X				752		// Minimized Button 위치 X
	...
	#define EXE2_BG_CANCEL_BTN_POS_X				772		// Cancel Button 위치 X
	...
	#define EXE2_BG_GAMESTART_BTN_POS_X				110		// GameStart Button 위치 X
	#define EXE2_BG_GAMESTART_BTN_POS_Y				461		// GameStart Button 위치 Y
	...
	#define EXE2_BG_UPDATE_PROGRESS_BAR_POS_Y		607		// Update Progress Bar 위치 Y
	...
	#define EXE2_BG_DOWNLOAD_FILE_STATIC_POS_X		19		// Download file info static control 위치 X
	#define EXE2_BG_DOWNLOAD_FILE_STATIC_POS_Y		575		// Download file info static control 위치 Y
	...
	#define EXE2_BG_DOWNLOAD_FILE_FONT_WEIGHT		FW_BOLD	// Download file info static control font 굵기
	#define EXE2_BG_DOWNLOAD_FILE_FONT_COLOR		RGB(255,255,255)	// Download file info static control font Color

	#define EXE2_BG_UPDATE_INFO_STATIC_POS_X		19		// Update info static control 위치 X
	#define EXE2_BG_UPDATE_INFO_STATIC_POS_Y		590		// Update info static control 위치 Y
	...
	// 2008-06-17 by cmkwon, WinnerOnline_Tha Launcher에서 이전 접속 계정 기억하기(K0000243) - 체크박스 위치
...
// end 2008-12-23 by ckPark 일본 런쳐
	...
	#define EXE2_BG_TITLE_BAR_SIZE_X				EXE2_LAUNCHER_BG_SIZE_X	// 타이틀바 이미지 Width
	#define EXE2_BG_TITLE_BAR_SIZE_Y				24						// 타이틀바 Height

	#define EXE2_BG_BACKGROUND_IMAGE_SIZE_X			EXE2_LAUNCHER_BG_SIZE_X									// 배경 이미지 Width
	#define EXE2_BG_BACKGROUND_IMAGE_SIZE_Y			(EXE2_LAUNCHER_BG_SIZE_Y - EXE2_BG_TITLE_BAR_SIZE_Y)	// 배경 이미지 Height

	#define EXE2_BG_WEBCONTROL_POS_X				17		// 웹브라우저 컨트롤 위치 X
	#define EXE2_BG_WEBCONTROL_POS_Y				58		// 웹브라우저 컨트롤 위치 Y
	#define EXE2_BG_WEBCONTROL_WIDTH				546		// 웹브라우저 컨트롤 Width
	#define EXE2_BG_WEBCONTROL_HEIGHT				482		// 웹브라우저 컨트롤 Height
	


// 2008-12-17 by ckPark 러시아 런쳐
#if defined(SERVICE_TYPE_RUSSIAN_SERVER_1)		// 러시아 런처 인터페이스 수정
	#define EXE2_BG_RESOLUTION_COMBOBOX_POS_X		693		// 해상도 선택 Combo Box 위치 X
	#define EXE2_BG_RESOLUTION_COMBOBOX_POS_Y		530		// 해상도 선택 Combo Box 위치 Y
	#define EXE2_BG_RESOLUTION_COMBOBOX_WIDTH		95		// 해상도 선택 Combo Box Width
	#define EXE2_BG_RESOLUTION_COMBOBOX_HEIGHT		16		// 해상도 선택 Combo Box Height
#else
	#define EXE2_BG_RESOLUTION_COMBOBOX_POS_X		591		// 해상도 선택 Combo Box 위치 X
	#define EXE2_BG_RESOLUTION_COMBOBOX_POS_Y		553		// 해상도 선택 Combo Box 위치 Y
	#define EXE2_BG_RESOLUTION_COMBOBOX_WIDTH		195		// 해상도 선택 Combo Box Width
	#define EXE2_BG_RESOLUTION_COMBOBOX_HEIGHT		20		// 해상도 선택 Combo Box Height
#endif
// end 2008-12-17 by ckPark 러시아 런쳐
		...
		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_X		720		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 X
		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_Y		531		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 Y
// 2008-01-15 by cmkwon, 2000_Yedang-Global_Kor 프로젝트 추가 - 아래와 같이 수정
...
//	#elif defined(SERVICE_TYPE_ENGLISH_SERVER_1) || defined(SERVICE_TYPE_ENGLISH_SERVER_2) || defined(SERVICE_TYPE_GERMAN_SERVER_1) || defined(SERVICE_TYPE_THAI_SERVER_1) || defined(SERVICE_TYPE_TURKISH_SERVER_1) || defined(SERVICE_TYPE_FRENCH_SERVER_1) || defined(SERVICE_TYPE_ITALIAN_SERVER_1) || defined(SERVICE_TYPE_POLISH_SERVER_1) || defined(SERVICE_TYPE_SPANISH_SERVER_1)
		...
		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_X		685		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 X
		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_Y		531		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 Y
	#elif defined(SERVICE_TYPE_CHINESE_SERVER_1) || defined(SERVICE_TYPE_TAIWANESE_SERVER_1)
		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_X		706		// 2008-01-17 by cmkwon, Exe2: Yetime_Chn 윈도우즈 모드 체크박스 위치 수정 - 
		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_Y		531		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 Y
	#elif defined(SERVICE_TYPE_RUSSIAN_SERVER_1)


// 2008-12-17 by ckPark 러시아 런쳐
// 		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_X		648		// 2008-01-17 by cmkwon, Exe2: Yetime_Chn 윈도우즈 모드 체크박스 위치 수정 - 
// 		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_Y		516		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 Y
		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_X		600		// 2008-01-17 by cmkwon, Exe2: Yetime_Chn 윈도우즈 모드 체크박스 위치 수정 - 
		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_Y		557		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 Y
// end 2008-12-17 by ckPark 러시아 런쳐
		...
		#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_Y		531		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 Y
	#endif
	// 2008-06-20 by cmkwon, Innova_Rus 요청으로 위치가 Y표도 다르기 때문에 위에 각자 추가함
	//#define EXE2_BG_WINDOWSMODE_CHECKBOX_POS_Y		531		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box 위치 Y
	#define EXE2_BG_WINDOWSMODE_CHECKBOX_WIDTH		13		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box Width
	#define EXE2_BG_WINDOWSMODE_CHECKBOX_HEIGHT		13		// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - Windows Mode Check Box Height
	...
	//#elif defined(SERVICE_TYPE_THAI_SERVER_1)	// 2008-06-17 by cmkwon, WinnerOnline_Tha Launcher에서 이전 접속 계정 기억하기(K0000243) - 
		...
		#define EXE2_BG_ACCOUNTNAME_EDIT_POS_X			630		// AccountName Edit Box 위치 X
		#define EXE2_BG_ACCOUNTNAME_EDIT_POS_Y			440		// AccountName Edit Box 위치 Y
		#define EXE2_BG_ACCOUNTNAME_EDIT_WIDTH			117		// AccountName Edit Box Width
		#define EXE2_BG_ACCOUNTNAME_EDIT_HEIGHT			15		// AccountName Edit Box Height

		#define EXE2_BG_PASSWORD_EDIT_POS_X				630		// Password Edit Box 위치 X
		#define EXE2_BG_PASSWORD_EDIT_POS_Y				463		// Password Edit Box 위치 Y
		#define EXE2_BG_PASSWORD_EDIT_WIDTH				117		// Password Edit Box Width
		#define EXE2_BG_PASSWORD_EDIT_HEIGHT			15		// Password Edit Box Height
	#else
		#define EXE2_BG_ACCOUNTNAME_EDIT_POS_X			666		// AccountName Edit Box 위치 X
	...
	#define EXE2_BG_SERVERLIST_BOX_POS_X			598		// ServerList Box 위치 X
	#define EXE2_BG_SERVERLIST_BOX_POS_Y			154		// ServerList Box 위치 Y
	...
	#define EXE2_BG_SERVERLIST_ITEM_ICON_POS_X		3		// ServerList Item Icon 위치 X
	#define EXE2_BG_SERVERLIST_ITEM_ICON_POS_Y		8		// ServerList Item Icon 위치 Y
	...
	// 2008-12-17 by ckPark 러시아 런쳐 - 아래와 같이 러시아를 다른 좌표로 수정 함.
	// 	#define EXE2_BG_MINIMIZED_BTN_POS_X				758		// Minimized Button 위치 X
	// 	#define EXE2_BG_MINIMIZED_BTN_POS_Y				0		// Minimized Button 위치 Y
	...
	// 	#define EXE2_BG_CANCEL_BTN_POS_X				778		// Cancel Button 위치 X
	// 	#define EXE2_BG_CANCEL_BTN_POS_Y				0		// Cancel Button 위치 Y
	// 	#define EXE2_BG_CANCEL_BTN_WIDTH				16		// Cancel Button Width
	// 	#define EXE2_BG_CANCEL_BTN_HEIGHT				20		// Cancel Button Height
	
	#if defined(SERVICE_TYPE_RUSSIAN_SERVER_1)		// 러시아 런처 인터페이스 수정
		#define EXE2_BG_MINIMIZED_BTN_POS_X				748		// Minimized Button 위치 X
		#define EXE2_BG_MINIMIZED_BTN_POS_Y				0		// Minimized Button 위치 Y
		#define EXE2_BG_MINIMIZED_BTN_WIDTH				21		// Minimized Button Width
	...
	#if defined(SERVICE_TYPE_KOREAN_SERVER_2)
		#define EXE2_BG_GAMESTART_BTN_POS_X				592		// GameStart Button 위치 X
		#define EXE2_BG_GAMESTART_BTN_POS_Y				442		// GameStart Button 위치 Y
	...
	#elif defined(SERVICE_TYPE_CHINESE_SERVER_1) || defined(SERVICE_TYPE_TAIWANESE_SERVER_1)
		#define EXE2_BG_GAMESTART_BTN_POS_X				662		// GameStart Button 위치 X
		#define EXE2_BG_GAMESTART_BTN_POS_Y				492		// GameStart Button 위치 Y
	...
	#elif defined(SERVICE_TYPE_THAI_SERVER_1) || defined(SERVICE_TYPE_SINGAPORE_1) || defined(SERVICE_TYPE_INDONESIA_SERVER_1)
		// 2008-06-17 by cmkwon, WinnerOnline_Tha Launcher에서 이전 접속 계정 기억하기(K0000243) - 
		#define EXE2_BG_GAMESTART_BTN_POS_X				628		// GameStart Button 위치 X
		#define EXE2_BG_GAMESTART_BTN_POS_Y				505		// GameStart Button 위치 Y
...
//#elif defined(SERVICE_TYPE_ENGLISH_SERVER_2) || defined(SERVICE_TYPE_GERMAN_SERVER_1) || defined(SERVICE_TYPE_TURKISH_SERVER_1) || defined(SERVICE_TYPE_FRENCH_SERVER_1) || defined(SERVICE_TYPE_ITALIAN_SERVER_1) || defined(SERVICE_TYPE_POLISH_SERVER_1) || defined(SERVICE_TYPE_SPANISH_SERVER_1)
		...
		// 2008-10-20 by cmkwon, Gameforge4D(Engilsh, German)에 접속 계정 기억하기 기능 추가 - 추가함
		#define EXE2_BG_GAMESTART_BTN_POS_X				676		// GameStart Button 위치 X
		#define EXE2_BG_GAMESTART_BTN_POS_Y				502		// GameStart Button 위치 Y
		#define EXE2_BG_GAMESTART_BTN_WIDTH				125		// GameStart Button Width
		#define EXE2_BG_GAMESTART_BTN_HEIGHT			23		// GameStart Button Height
	...
	// 2008-12-17 by ckPark 러시아 런쳐
	#elif defined(SERVICE_TYPE_RUSSIAN_SERVER_1)
		#define EXE2_BG_GAMESTART_BTN_POS_X				648		// GameStart Button 위치 X
		#define EXE2_BG_GAMESTART_BTN_POS_Y				492		// GameStart Button 위치 Y
		#define EXE2_BG_GAMESTART_BTN_WIDTH				125		// GameStart Button Width
		#define EXE2_BG_GAMESTART_BTN_HEIGHT			23		// GameStart Button Height
	// 2008-12-17 by ckPark 러시아 런쳐
...
// 2008-12-23 by ckPark 일본 런쳐
	...
	#define EXE2_BG_UPDATE_PROGRESS_BAR_POS_X		26		// Update Progress Bar 위치 X
	#define EXE2_BG_UPDATE_PROGRESS_BAR_POS_Y		602		// Update Progress Bar 위치 Y = (EXE2_LAUNCHER_BG_SIZE_Y - 23)
	...
	#define EXE2_BG_DOWNLOAD_FILE_STATIC_POS_X		90		// Download file info static control 위치 X
	#define EXE2_BG_DOWNLOAD_FILE_STATIC_POS_Y		579		// Download file info static control 위치 Y
	#define EXE2_BG_DOWNLOAD_FILE_STATIC_WIDTH		200		// Download file info static control Width
	#define EXE2_BG_DOWNLOAD_FILE_STATIC_HEIGHT		13		// Download file info static control Height
...
// 2008-12-23 by ckPark 일본 런쳐
	...
	#define EXE2_BG_UPDATE_INFO_STATIC_POS_X		190		// Update info static control 위치 X
	#define EXE2_BG_UPDATE_INFO_STATIC_POS_Y		579		// Update info static control 위치 Y
	#define EXE2_BG_UPDATE_INFO_STATIC_WIDTH		290		// Update info static control Width
	#define EXE2_BG_UPDATE_INFO_STATIC_HEIGHT		13		// Update info static control Height
...
// end 2008-12-17 by ckPark 러시아 런쳐
	...
	#elif defined(SERVICE_TYPE_THAI_SERVER_1) || defined(SERVICE_TYPE_SINGAPORE_1) || defined(SERVICE_TYPE_INDONESIA_SERVER_1)
		#define EXE2_BG_REMEMBERID_CHECKBOX_POS_X		630		// Remember ID CheckBox 위치 X
		#define EXE2_BG_REMEMBERID_CHECKBOX_POS_Y		486		// Remember ID CheckBox 위치 Y
		#define EXE2_BG_REMEMBERID_CHECKBOX_WIDTH		13		// Remember ID CheckBox Width
		#define EXE2_BG_REMEMBERID_CHECKBOX_HEIGHT		13		// Remember ID CheckBox Height
	// 2008-12-22 by cmkwon, 지원 서비스 추가(Gameforge4D 터키아, 불어, 이탈리아어) - 아래와 같이 3개 서비스 추가
	//#elif defined(SERVICE_TYPE_ENGLISH_SERVER_2) || defined(SERVICE_TYPE_GERMAN_SERVER_1)
...
//elif defined(SERVICE_TYPE_ENGLISH_SERVER_2) || defined(SERVICE_TYPE_GERMAN_SERVER_1) || defined(SERVICE_TYPE_TURKISH_SERVER_1) || defined(SERVICE_TYPE_FRENCH_SERVER_1) || defined(SERVICE_TYPE_ITALIAN_SERVER_1) || defined(SERVICE_TYPE_POLISH_SERVER_1) || defined(SERVICE_TYPE_SPANISH_SERVER_1)
		...
		// 2008-10-20 by cmkwon, Gameforge4D(Engilsh, German)에 접속 계정 기억하기 기능 추가 - 추가함
		#define EXE2_BG_REMEMBERID_CHECKBOX_POS_X		666		// Remember ID CheckBox 위치 X
		#define EXE2_BG_REMEMBERID_CHECKBOX_POS_Y		483		// Remember ID CheckBox 위치 Y
		#define EXE2_BG_REMEMBERID_CHECKBOX_WIDTH		13		// Remember ID CheckBox Width
		#define EXE2_BG_REMEMBERID_CHECKBOX_HEIGHT		13		// Remember ID CheckBox Height		
	#else
		#define EXE2_BG_REMEMBERID_CHECKBOX_POS_X		666		// Remember ID CheckBox 위치 X
...
#if defined(SERVICE_TYPE_KOREAN_SERVER_1) || defined(SERVICE_TYPE_ENGLISH_SERVER_2) || defined(SERVICE_TYPE_GERMAN_SERVER_1) || defined(SERVICE_TYPE_TURKISH_SERVER_1) || defined(SERVICE_TYPE_FRENCH_SERVER_1) || defined(SERVICE_TYPE_ITALIAN_SERVER_1) || defined(SERVICE_TYPE_POLISH_SERVER_1) || defined(SERVICE_TYPE_SPANISH_SERVER_1) || defined(SERVICE_TYPE_ARGENTINA_SERVER_1)
	///////////////////////////////////////////////////////////////////////////////
	// 2008-10-16 by cmkwon, Gameforge4D(Eng,Deu) Launcher Registry event 구현 - Registry URL 이 있다면 그 URL로 변경한다.
...
#if !defined(SERVICE_TYPE_KOREAN_SERVER_2) || defined(_DEBUG)	// 2007-09-07 by cmkwon, 한국 예타임만 Release만 입력이 없다
...
//#if defined(SERVICE_TYPE_KOREAN_SERVER_1) || defined(SERVICE_TYPE_THAI_SERVER_1)	// 2008-06-17 by cmkwon, WinnerOnline_Tha Launcher에서 이전 접속 계정 기억하기(K0000243) - 
// 2008-12-22 by cmkwon, 지원 서비스 추가(Gameforge4D 터키아, 불어, 이탈리아어) - 아래와 같이 3개 서비스 추가
//#if defined(SERVICE_TYPE_KOREAN_SERVER_1) || defined(SERVICE_TYPE_THAI_SERVER_1) || defined(SERVICE_TYPE_ENGLISH_SERVER_2) || defined(SERVICE_TYPE_GERMAN_SERVER_1)	// 2008-06-17 by cmkwon, WinnerOnline_Tha Launcher에서 이전 접속 계정 기억하기(K0000243) - 
// 2009-06-04 by cmkwon, 지원 서비스 추가(Gameforge4D 폴란드어, 스페인어) - 
...
// 2009-07-10 by cmkwon, 러시아 Frost 신규 Lib로 수정 - 
// 	// 2009-01-30 by cmkwon, 러시아 Innova 런처 시스템(프로스트) 수정 - ReadLoginAddr() 호출
...
// 		return FALSE;
// 	}	
// 	STRNCPY_MEMSET(preServerIP, ip, 128);	// IP 변경
// 	nPreServerPort		= port;				// Port 변경
	///////////////////////////////////////////////////////////////////////////////
	// 2009-07-10 by cmkwon, 러시아 Frost 신규 Lib로 수정 - 
...
#if defined(SERVICE_TYPE_JAPANESE_SERVER_1)
						// 2008-12-18 by cmkwon, 일본 Arario 런처 수정 - 접속 버튼 처리
						this->OnOk();
#endif
					}
					break;
...
//#if defined(SERVICE_TYPE_RUSSIAN_SERVER_1)
#if defined(SERVICE_TYPE_RUSSIAN_SERVER_1) && defined(_USING_INNOVA_FROST_)
// 2009-07-10 by cmkwon, 러시아 Frost 신규 Lib로 수정 - 기존 소스 주석 처리
// 						// 2009-01-30 by cmkwon, 러시아 Innova 런처 시스템(프로스트) 수정 - SetUserName() 호출 처리
// 						try
// 						{
...
// 										
// 
// 						// 2009-01-30 by cmkwon, 러시아 Innova 런처 시스템(프로스트) 수정 - ChangeGameAddr() 호출 처리
...
// 2007-12-27 by cmkwon, 윈도우즈 모드 기능 추가 - 아래와 같이 수정함
//						switch(m_nWindowDegreeReg)
//						{
//// 2007-07-24 by cmkwon, 런처에서 800*600 해상도 삭제 - 
...
// 2008-01-22 by cmkwon, S_Exe2: 예당 본섭 런처에  윈도우즈모드 적용
// 		#if defined(SERVICE_TYPE_KOREAN_SERVER_2) && !defined(_TEST_SERVER)
// 						// 2008-01-09 by cmkwon, Yedang_Kor_Main 윈도우즈모드 비활성화 - 항상 풀모드로 실행
// 						m_nWindowModeReg	= GAME_MODE_FULLSCREEN;
// 		#endif

						// 2008-01-08 by cmkwon, WindowMode 추가함 - 아래와 같이 수정
...
//
//						// 2007-05-17 by cmkwon, for문을 수정함
...
// 2009-06-09 by cmkwon, 일본 Arario dbg로 접속 가능하게 수정 - 패스워드도 1111로 고정
...
// 2008-02-14 by cmkwon, 런처에서 서버그룹 명이 깨져도 게임 실행에 문제가 없도록 수정 - 아래와 같이 수정함
// 	///////////////////////////////////////////////////////////////////////////////
// 	// 선택한 ServerGroupName을 가져온다(혼잡도가 포함되어있다)
// 	// 7/13/2006 by dgwoo
// 	m_ServerList->GetTextString(m_ServerList->GetCurSel(), szSelectedServerName);
// 	///////////////////////////////////////////////////////////////////////////////
// 	// 가져온 ServerGroupName에서 혼잡도 정보를 제거한다
...
#if defined(SERVICE_TYPE_JAPANESE_SERVER_1)
	// 2008-12-18 by cmkwon, 일본 Arario 런처 수정 - MSG_PC_CONNECT_LOGIN에 SesstionKey를 설정한다.
	STRNCPY_MEMSET(msgLogin->WebLoginAuthKey, (LPCSTR)m_csSessionKey, SIZE_MAX_WEBLOGIN_AUTHENTICATION_KEY);
#endif

#if defined(SERVICE_TYPE_RUSSIAN_SERVER_1)
	///////////////////////////////////////////////////////////////////////////////
	// 2010-04-26 by cmkwon, 러시아 Innva 인증/빌링 시스템 변경 - 암호화 하지 않은 패스워드를 넘긴다.
	STRNCPY_MEMSET(msgLogin->WebLoginAuthKey, (LPCSTR)m_szPassword, SIZE_MAX_WEBLOGIN_AUTHENTICATION_KEY);
#endif
...
int CAtumLauncherDlg::NTOnReceivedNetworkCheckOK(int i_nCheckCount)
{
	...
	Sleep(5);		// 2007-06-19 by cmkwon, 약간의 시간차를 둔다
...
// 2008-10-20 by cmkwon, Gameforge4D(Engilsh, German)에 접속 계정 기억하기 기능 추가 - 아래와 같이 수정
//#elif defined(SERVICE_TYPE_KOREAN_SERVER_1) || defined(SERVICE_TYPE_THAI_SERVER_1)		// 2008-06-17 by cmkwon, WinnerOnline_Tha Launcher에서 이전 접속 계정 기억하기(K0000243) - 
// 2008-12-22 by cmkwon, 지원 서비스 추가(Gameforge4D 터키아, 불어, 이탈리아어) - 아래와 같이 3개 서비스 추가
//#elif defined(SERVICE_TYPE_KOREAN_SERVER_1) || defined(SERVICE_TYPE_THAI_SERVER_1) || defined(SERVICE_TYPE_ENGLISH_SERVER_2) || defined(SERVICE_TYPE_GERMAN_SERVER_1)		// 2008-06-17 by cmkwon, WinnerOnline_Tha Launcher에서 이전 접속 계정 기억하기(K0000243) - 
// 2009-06-04 by cmkwon, 지원 서비스 추가(Gameforge4D 폴란드어, 스페인어) -  
...
// 2009-07-10 by cmkwon, 러시아 Frost 신규 Lib로 수정 - 기존 소스 주석 처리
// // 2009-01-30 by cmkwon, 러시아 Innova 런처 시스템(프로스트) 수정 - 아래와 같이 러시아만 따로 처리, AyyoCreateProcess() 호출 처리
// // 2009-04-23 by cmkwon, 러시아 Innova Frost 임시 제거하기 - 아래와 같이 define 으로 처리 함.
// //#if defined(SERVICE_TYPE_RUSSIAN_SERVER_1)
// #if defined(SERVICE_TYPE_RUSSIAN_SERVER_1) && defined(_USING_INNOVA_FROST_)
// 	if(NULL == i_szAppPath
