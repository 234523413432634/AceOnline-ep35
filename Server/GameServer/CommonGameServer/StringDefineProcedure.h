...
#define PROCEDURE_080822_0134 (UCHAR*)"{call dbo.atum_GetQuickSlot(?,?)}"
#define PROCEDURE_080822_0135 (UCHAR*)"{call dbo.atum_delete_QuickSlot(?,?,?)}"
							 
#define PROCEDURE_080822_0136 (UCHAR*)"{call dbo.atum_Update_QuickSlot(?,?,?,?,?, ?,?,?,?,? ,?,?,?)}"
...
#ifdef S_LOGIN_ITEM_EVENT_SHCHO
...
#else
#define PROCEDURE_080827_0266 (UCHAR*)"{call dbo.atum_PROCEDURE_080827_0266(?,?,?,?,?,?,?,?,?,?, ?,?,?,?,?,?,?,?)}"			// 2009-11-19 by cmkwon, 아이템 이벤트에 Account/Character 체크 기능 추가 - 인자 1개 추가 // 2010-06-16 by jskim, 레벨별 이벤트 체크 기능 -
#define PROCEDURE_080827_0267 (UCHAR*)"{call dbo.atum_PROCEDURE_080827_0267(?)}"
#define PROCEDURE_080827_0268 (UCHAR*)"{call dbo.atum_PROCEDURE_080827_0268(?,?,?,?,?,?,?,?,?,?, ?,?,?,?,?,?,?,?,?)}"		// 2009-11-19 by cmkwon, 아이템 이벤트에 Account/Character 체크 기능 추가 - 인자 1개 추가 // 2010-06-16 by jskim, 레벨별 이벤트 체크 기능 -
#define PROCEDURE_080827_0269 (UCHAR*)"{call dbo.atum_PROCEDURE_080827_0269(?,?,?,?,?,?,?,?,?)}"
#endif
...
#define PROCEDURE_090709_0355 (UCHAR*)"{call dbo.atum_import_ti_itemmixinginfo(?,?,?,?,?,?,?,?,?,?,?,?,?)}"
...
#define PROCEDURE_100615_0567 (UCHAR*)"{call dbo.atum_Insert_td_pet(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?)}" // 2010-06-15 by shcho&hslee 펫시스템 - 유저가 가진 펫 정보 테이블에 추가(서버내부 저장)
#define PROCEDURE_100615_0568 (UCHAR*)"{call dbo.atum_Insert_ti_pet(?,?,?,?,?,?)}" // 2010-06-15 by shcho&hslee 펫시스템 - 기본 정보 펫 테이블 정보 저장 프로시저 (엑셀밀기)
...
#define PROCEDURE_100615_0571 (UCHAR*)"{call dbo.atum_InsertStorePetItem(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?)}" // 2010-06-15 by shcho&hslee 펫시스템 - 개인이 가진 팻정보 테이블을 가져오는 프로시저(로드)
#define PROCEDURE_100615_0574 (UCHAR*)"{call dbo.atum_Insert_ti_petLevel(?,?,?,?,?, ?,?,?,?,?, ?,?,?)}" // 2010-06-15 by shcho&hslee 펫시스템 - 기본 레벨 정보 펫 테이블 정보 저장 프로시저 (엑셀밀기)
