...
#ifdef ARENA
#define GLOBAL_CONFIG_FILE_PATH					(string(CONFIG_ROOT)+string("./aglobal.cfg")).c_str()
#define IM_SERVER_CONFIG_FILE_PATH				(string(CONFIG_ROOT)+string("./aim.cfg")).c_str()
#define FIELD_SERVER_CONFIG_FILE_PATH			(string(CONFIG_ROOT)+string("./afield.cfg")).c_str()
#define NPC_SERVER_CONFIG_FILE_PATH				(string(CONFIG_ROOT)+string("./anpc.cfg")).c_str()
...
#define AUTHENTICATION_CONFIG_FILE_PATH					(string(CONFIG_ROOT)+string("./authentication.cfg")).c_str()
#else
...
#define LOCALIZATION_CONFIG_DIRECTORY_PATH		(string(CONFIG_ROOT)+string("/localization")).c_str()
#define AUTHENTICATION_CONFIG_FILE_PATH					(string(CONFIG_ROOT)+string("./authentication.cfg")).c_str()
#endif		// 2011-01-26 by hskim, 인증 서버 구현
...
const UINT TIMERGAP_GLOGSYSTEM					= 3600000;				// 1시간 (60*60*1000)		// 2010-06-01 by shcho, GLogDB 관련 -
