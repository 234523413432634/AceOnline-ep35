...
#define ERR_PROTOCOL_INVALID_AUTHENTICATION_SERVER_LOGIN_DATA					0x7001		// PreServer 로 부터 받은 Data Size가 Authentication Packet Type에 따른 Data Size보다 작음
#define ERR_PROTOCOL_INVALID_AUTHENTICATION_SERVER_LOGIN_DB						0x7002		// PreServer 로 부터 받은데이타를 사용해 인증절차를 거쳤지만 중간에 정상적으로 처리되지 않았다
