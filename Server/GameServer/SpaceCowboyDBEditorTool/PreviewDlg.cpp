...
bool CPreviewDlg::InsertQuest()
{
	...
	for(int i = 0; i<m_pQuestEditorDlg->m_ctrlListCtrlReqItem.GetItemCount(); i++)
	szQuest +=		"\t\tS_REQ_ITEM	=" + m_pQuestEditorDlg->m_ctrlListCtrlReqItem.GetItemText(i,0)+";\r\n";
	for(int i = 0; i<m_pQuestEditorDlg->m_ctrlListCtrlReqIndex.GetItemCount(); i++)
	szQuest +=		"\t\tS_REQ_QUEST_INDEX	=" + m_pQuestEditorDlg->m_ctrlListCtrlReqIndex.GetItemText(i,0)+";\r\n";
	for(int i = 0; i<m_pQuestEditorDlg->m_ctrlListCtrlRecvReqIndex.GetItemCount(); i++)
	...
	szQuest +=		"\t{\r\n";
	for(int i = 0; i<m_pQuestEditorDlg->m_ctrlListCtrlPayItem.GetItemCount(); i++)
	szQuest +=		"\t\tS_PAY_ITEM	=" + m_pQuestEditorDlg->m_ctrlListCtrlPayItem.GetItemText(i,0)+";\r\n";
	for(int i = 0; i<m_pQuestEditorDlg->m_ctrlListCtrlSDelItem.GetItemCount(); i++)
	...
	szQuest +=		"\t\t};\r\n";
	for(int i = 0; i<m_pQuestEditorDlg->m_ctrlListCtrlCReqItem.GetItemCount(); i++)
	...
	for(int i=0; i < m_pQuestEditorDlg->m_ctrlList_reqMonsterList.GetItemCount(); i++)
	{
...
//	szQuest +=		"\t\tC_PAY_BONUS_SKILL_POINT	= " + m_pQuestEditorDlg->m_valueEditPayBonusSkillPoint+";\r\n";
	...
	for(int i = 0; i<m_pQuestEditorDlg->m_ctrlListCtrlCADelItem.GetItemCount(); i++)
	szQuest +=		"\t\tC_DEL_ITEM	=" + m_pQuestEditorDlg->m_ctrlListCtrlCADelItem.GetItemText(i,0)+";\r\n";
	for(int i = 0; i<m_pQuestEditorDlg->m_ctrlListCtrlCAPayItem.GetItemCount(); i++)
	...
	for(int i = 0; i<m_pQuestEditorDlg->m_ctrlListCtrlCARandomPayItem.GetItemCount(); i++)
	...
	{
	szQuest +=		"\t\tC_MIX_ITEM	=";
	for(int i = 0; i<m_pQuestEditorDlg->m_ctrlListCtrlCAMixItem.GetItemCount(); i++)
