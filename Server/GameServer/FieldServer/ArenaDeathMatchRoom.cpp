...
//			this->SendWatchRemoveUser(*itr);		// 2007-06-18 by dhjin, 아레나에서 나간 유저 정보 전송.
		...
		//////////////////////////////////////////////////////////////////////////
		// 2007-04-25 by dhjin, 보상 WarPoint 지급
		INT PlusWarPoint = pFISocket->CalcWarPoint(VCNBaseWarPoint, TRUE); // 2007-09-14 by dhjin, WarPoint 값 계산 함수 추가
//		INT PlusWarPoint = (INT)(VCNBaseWarPoint * pFISocket->GetPlusWarPointRate());	// 2007-06-26 by dhjin, 워포인트 이벤트로 워포인트 증가량 추가	
...
//			this->SendWatchRemoveUser(*itr);		// 2007-06-18 by dhjin, 아레나에서 나간 유저 정보 전송.
		...
		//////////////////////////////////////////////////////////////////////////
		// 2007-04-25 by dhjin, 보상 WarPoint 지급,
		INT PlusWarPoint = pFISocket->CalcWarPoint(ANIBaseWarPoint, TRUE); // 2007-09-14 by dhjin, WarPoint 값 계산 함수 추가
//		INT PlusWarPoint = (INT)(ANIBaseWarPoint * pFISocket->GetPlusWarPointRate());	// 2007-06-26 by dhjin, 워포인트 이벤트로 워포인트 증가량 추가	
