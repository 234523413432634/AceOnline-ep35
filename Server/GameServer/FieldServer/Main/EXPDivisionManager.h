...
public:
	...
	void ProcessEXPDivision(DROPITEM *o_pDropItem, MSG_FL_LOG_MONSTER_BOSS *o_pLogMonsterBoss, Experience_t i_exp, BOOL i_bBossMonster);
	...
	void ProcessEXPDivisionInfinityMap(DROPITEM *o_pDropItem, MSG_FL_LOG_MONSTER_BOSS *o_pLogMonsterBoss, Experience_t i_exp, BOOL i_bBossMonster);		// 2009-09-09 ~ 2010 by dhjin, 인피니티 - 인피 맵에선 파티 상관없이 맵 모든 유저 경험치 균등분배.
