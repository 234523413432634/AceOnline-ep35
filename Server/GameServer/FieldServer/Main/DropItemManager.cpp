...
BOOL CDropItemManager::DropItem(CFieldMapChannel *i_pFieldMapChannel, D3DXVECTOR3 *i_pDropPosition, INT i_nItemNum, INT i_nCountableItemCount /* = 1 */)
{
	// find item info
...
BOOL CDropItemManager::DropItemInRandomRadius(CFieldMapChannel *i_pFieldMapChannel, D3DXVECTOR3 *i_pDropPosition, INT i_nRadius, INT i_nItemNum, INT i_nCountableItemCount /* = 1 */)
{
	...
	return DropItem(i_pFieldMapChannel, &RadomPosition, i_nItemNum, i_nCountableItemCount);	
}
