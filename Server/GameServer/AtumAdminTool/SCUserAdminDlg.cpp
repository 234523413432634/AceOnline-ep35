...
// 	SQLBindParameter(m_pODBCStmt->m_hstmt, 1, SQL_PARAM_INPUT, SQL_C_CHAR, SQL_VARCHAR, SIZE_MAX_SQL_PATTERN_BUFFER, 0, GetSqlPattern((LPCSTR)m_szCurrentCharacterName, spbuf), 0, &cb1);
	...
	BOOL bRet = m_pODBCStmt->ExecuteQuery((char*)(PROCEDURE_080822_0025));
	if (!bRet)
	{
		// clean up
...
// 	BOOL bRet = m_pODBCStmt->ExecuteQuery((LPCSTR)szQuery);
	...
	BOOL bRet = m_pODBCStmt->ExecuteQuery((char*)(PROCEDURE_080827_0033));
	if (!bRet)
	{
...
void CSCUserAdminDlg::OnCmgModifyItem() 
{
	...
	if(FALSE == this->DBQ_LoadEnchantList(&enchantItemNumList, itemToMod.UniqueNumber, itemToMod.Kind))
	{
		return;
	}
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
void CSCUserAdminDlg::GetItemInfoListByDesParam(vectItemPtr *o_pVectItemList, BYTE i_byDesParam)
{
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
BOOL CSCUserAdminDlg::DBQ_LoadEnchantList(vectINT *o_pVecEnchantItemNumList, UID64_t i_ItemUID, BYTE i_byItemKind)
{
