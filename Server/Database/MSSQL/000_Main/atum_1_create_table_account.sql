...
CREATE TABLE dbo.ti_Item (
	...
	DestParameter5	TINYINT,			-- // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 대상파라미터5
	ParameterValue5	FLOAT,				-- // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 수정파라미터5
	DestParameter6	TINYINT,			-- // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 대상파라미터6
	ParameterValue6	FLOAT,				-- // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 수정파라미터6
	DestParameter7	TINYINT,			-- // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 대상파라미터7
	ParameterValue7	FLOAT,				-- // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 수정파라미터7
	DestParameter8	TINYINT,			-- // 2009-04-21 by cmkwon, ITEM에 DesParam 필드 개수 8개로 늘리기 - 대상파라미터8
...
CREATE TABLE dbo.ti_ItemMixingInfo (
	...
	SourceItemNum1			INT	NOT NULL,				-- 필요한 재료 ItemNum		--REFERENCES ti_Item(ItemNum)

	SourceItemCount1		INT	NOT NULL,				-- 필요한 개수
	SourceItemNum2			INT	NOT NULL DEFAULT(0),	-- 필요한 재료 ItemNum		--REFERENCES ti_Item(ItemNum)
	SourceItemCount2		INT	NOT NULL DEFAULT(0),	-- 필요한 개수
	SourceItemNum3			INT	NOT NULL DEFAULT(0),	-- 필요한 재료 ItemNum		--REFERENCES ti_Item(ItemNum)
	SourceItemCount3		INT	NOT NULL DEFAULT(0),	-- 필요한 개수
	SourceItemNum4			INT	NOT NULL DEFAULT(0),	-- 필요한 재료 ItemNum		--REFERENCES ti_Item(ItemNum)
	SourceItemCount4		INT	NOT NULL DEFAULT(0),	-- 필요한 개수
	SourceItemNum5			INT	NOT NULL DEFAULT(0),	-- 필요한 재료 ItemNum		--REFERENCES ti_Item(ItemNum)
...
CREATE TABLE dbo.ti_InvokingWearItemDPNum (
	...
	InvokingDestParam			TINYINT			NOT NULL,
...
CREATE TABLE dbo.ti_InvokingWearItemDPNumByUse (
	...
	InvokingDestParamByUse			TINYINT			NOT NULL,
...
(
	...
	PetEXP			FLOAT	NOT NULL ,
	Stamina			FLOAT	NOT NULL ,
	CitySourceIndex		INT	NOT NULL ,
	FieldSourceIndex	INT	NOT NULL ,
	PetAttackIndex		INT	NOT NULL , -- // 2010-06-15 by shcho&hslee 펫시스템 - 펫 공격 처리 총알 인덱스 필드 추가
	PetSkillslot0		INT	NOT NULL ,
	PetSkillslot1		INT	NOT NULL ,
	PetSkillslot2		INT	NOT NULL ,
	PetSkillslot3		INT	NOT NULL ,
	PetSkillslot4		INT	NOT NULL ,
	PetSkillslot5		INT	NOT NULL 
)
GO
...
(
	...
	DefaultPetName	VARCHAR(40)	COLLATE Korean_Wansung_CI_AS NULL ,
	EnableName	INT		NOT NULL ,
	EnableLevel	INT		NOT NULL 
)
GO
--------------------------------------------------------------------------------
