...
void CNTDbgHelperWindow::OnCreateControl()
{
	...
	CreateWindow(_T("button"), _T("보  고"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON , 10 , WIN_HEIGHT-80, 70, 30, m_Mainhwnd, (HMENU)IDC_DUMPSEND, GetModuleHandle( NULL ), NULL);
	CreateWindow(_T("button"), _T("상세히"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON , 90 , WIN_HEIGHT-80, 70, 30, m_Mainhwnd, (HMENU)IDC_MOREINFO, GetModuleHandle( NULL ), NULL);
	CreateWindow(_T("button"), _T("취  소"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON , 170, WIN_HEIGHT-80, 70, 30, m_Mainhwnd, (HMENU)IDC_DUMPCANCEL, GetModuleHandle( NULL ), NULL);
	...
	CreateWindow(_T("button"), _T("보  고"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON , 10 , WIN_MOREHEIGHT-80, 70, 30, m_Morehwnd, (HMENU)IDC_DUMPSEND, GetModuleHandle( NULL ), NULL);
	CreateWindow(_T("button"), _T("간단히"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON , 90 , WIN_MOREHEIGHT-80, 70, 30, m_Morehwnd, (HMENU)IDC_MAININFO, GetModuleHandle( NULL ), NULL);
	CreateWindow(_T("button"), _T("취  소"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON , 170, WIN_MOREHEIGHT-80, 70, 30, m_Morehwnd, (HMENU)IDC_DUMPCANCEL, GetModuleHandle( NULL ), NULL);
