...
#define		NO_GAMEGUARD
	...
	#define		GAMEGUARD_TYPE					USE_GAMEGUARD_NONE
	#define		DEFINE_USE_GAMEGUARD_NONE
...
// end 2008-12-09 by dgwoo 미션마스터.
	...
	void FieldSocketCurrentPetSkillData(MSG_FC_ITEM_PET_SKILLDATA* pMsg);
	void FieldSocketCurrentPetSocketData(MSG_FC_ITEM_PET_SOCKETDATA* pMsg);
