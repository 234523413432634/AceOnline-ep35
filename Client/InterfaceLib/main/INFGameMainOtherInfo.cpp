...
#define FONTOTHERINFO_Y				-2
#else
#define FONTOTHERINFO_Y				0
#endif
...
//	m_pImgHpRight->InitDeviceObjects(pDataHeader->m_pData, pDataHeader->m_DataSize);
	...
	m_pImgTargetInfoBack = new CINFImage;
	m_pImgTargetInfoBack->InitDeviceObjects(pDataHeader->m_pData, pDataHeader->m_DataSize);

	pDataHeader = m_pGameData->Find("Monbar");
	m_pImgTargetInfoBar = new CINFImage;
	m_pImgTargetInfoBar->InitDeviceObjects(pDataHeader->m_pData, pDataHeader->m_DataSize);
