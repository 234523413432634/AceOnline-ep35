...
protected:
	...
	CINFImage	*	m_pPartyFrame;
	CINFImage	*	m_pPartyFrameFuel;
	CINFImage	*	m_pPartyFrameHP;
	//CINFImage	*	m_pPartyVOIPButton[4];
	CINFImage	*	m_pPartyTalking;
	...
	// 2008-04-04 by bhsohn Ep3 커뮤니티 창
	CINFImage*					m_pImgBk[MAX_WND_PARTYMODE];	// 배경
	...
	CINFImage*					m_pLockImage;
	CINFImage*					m_pUnLockImage;
	CINFImage*					m_pVOIPImage;
	CINFImage*					m_pVOIPSpeakingImage;
	...
	CINFImage*				m_pSelImage;			// 파티원선택이미지
	int						m_nPartyOPSel;
	...
	CINFImage*				m_pFormatImage[MAX_COMBO_FLIGHT_FORM];		
