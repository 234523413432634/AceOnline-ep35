...
private:
	...
	CINFImage*					m_pRoomDifficultSetBG;			// 난이도 설정 BG.
	...
	CINFImage*		m_pMinimizeBKB;			// 최소화 팝업 백그라운드

	CINFImage*		m_pMinimizeBKW;			// 최소화 팝업 백그라운드
	...
	CINFImage*		m_pBlingBK;				// 현재 깜빡일 배경
