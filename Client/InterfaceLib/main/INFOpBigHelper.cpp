...
HRESULT CINFOpBigHelper::InitDeviceObjects()
{
	...
	{	
		...
		m_pBigOpBk = new CINFImage;
		pDataHeader = m_pParent->FindResource(szImage);
		m_pBigOpBk->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);		
	}
...
// 		m_pExplainList[nCnt]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);
	...
	m_pExplainList[0] = new CINFImage;
	pDataHeader = m_pParent->FindResource(szImage);
	m_pExplainList[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);	
	...
	{		
		...
		m_pExplainList[nCnt+1] = new CINFImage;
		pDataHeader = m_pParent->FindResource(szImage);
		m_pExplainList[nCnt+1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);
