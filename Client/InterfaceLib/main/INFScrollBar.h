...
protected:
	...
	CINFImage*		m_pScrollLine[3];		//	스크롤 라인의 윗부분, 중간, 아랫부분
...
protected:
	CINFImage*				m_ImgScrollBar;
	CINFImage*				m_ImgScrollLine;
	CINFImage*				m_ImgScrollTopBtn[4];
	CINFImage*				m_ImgScrollBottomBtn[4];
