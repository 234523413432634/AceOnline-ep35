...
HRESULT CINFOpWnd::InitDeviceObjects()
{
	...
	{	
		...
		m_pNPCImage[OPWND_NPC_IMAGE_VCU][OPWND_BK_IMAGE_QUEST] = new CINFImage;
		pDataHeader = g_pGameMain->FindResource(szImage);
		m_pNPCImage[OPWND_NPC_IMAGE_VCU][OPWND_BK_IMAGE_QUEST]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;		

		// 화난 표정
		wsprintf(szImage,"opsnpcvcu2");
		m_pNPCImage[OPWND_NPC_IMAGE_VCU][OPWND_BK_IMAGE_INFLWAR] = new CINFImage;
		pDataHeader = g_pGameMain->FindResource(szImage);
		m_pNPCImage[OPWND_NPC_IMAGE_VCU][OPWND_BK_IMAGE_INFLWAR]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;		

		
		// 일반 표정
		wsprintf(szImage,"opsnpcani1");
		m_pNPCImage[OPWND_NPC_IMAGE_ANI][OPWND_BK_IMAGE_QUEST] = new CINFImage;
		pDataHeader = g_pGameMain->FindResource(szImage);
		m_pNPCImage[OPWND_NPC_IMAGE_ANI][OPWND_BK_IMAGE_QUEST]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;				

		// 화난 표정
		wsprintf(szImage,"opsnpcani2");
		m_pNPCImage[OPWND_NPC_IMAGE_ANI][OPWND_BK_IMAGE_INFLWAR] = new CINFImage;
		pDataHeader = g_pGameMain->FindResource(szImage);
		m_pNPCImage[OPWND_NPC_IMAGE_ANI][OPWND_BK_IMAGE_INFLWAR]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;				
	}
	...
	{	
		...
		m_pBkImage[OPWND_BK_IMAGE_QUEST] = new CINFImage;
		pDataHeader = g_pGameMain->FindResource(szImage);
		m_pBkImage[OPWND_BK_IMAGE_QUEST]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;		

		wsprintf(szImage,"opsbk2");
		m_pBkImage[OPWND_BK_IMAGE_INFLWAR] = new CINFImage;
		pDataHeader = g_pGameMain->FindResource(szImage);
		m_pBkImage[OPWND_BK_IMAGE_INFLWAR]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;				
	}
