...
//				ERROR Reporting ( exit )
	...
	m_pGage[0] = new CINFImage;
	pDataHeader = FindResource("selHP");
	m_pGage[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);
	m_pGage[1] = new CINFImage;
	pDataHeader = FindResource("selSP");
	m_pGage[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);
	m_pGage[2] = new CINFImage;
	pDataHeader = FindResource("selDP");
	m_pGage[2]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);
