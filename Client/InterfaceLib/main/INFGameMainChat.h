...
#define CHATBOX_SCROLL_IMAGE_GAP_X			3//4						// 스크롤 이미지 X Gap 
...
//	CINFImage	*	m_pTabButton[CHAT_MENUBOX_SELECT_COUNT][CHAT_MENUBOX_SELECT_STATE];															 // 채팅 버튼상태(일반, 귓속말, 편대, 여단, 음성)
	CINFImage	*	m_pChatBox[CHATBOX_IMAGE_NUMBER];					// 채팅 박스 이미지(기본 틀이미지)
	CINFImage	*	m_pScrollLine[CHATBOX_IMAGE_SCROLL_LINE_NUMBER];	// 스크롤 라인 이미지
	CINFImage	*	m_pChatViewButton[2][BUTTON_BOTH_STATE_NUMBER];		// 채팅박스 보여주기와 감추기
	CINFImage	*	m_pChatShowImage;									// 채팅박스 타이틀
	CINFImage	*	m_pScrollButton;									// 스크롤 버튼 이미지

	// 추가수정 2005.01.21
	CINFImage	*	m_pNChatInput;										// 채팅 입력창
	CINFImage	*	m_pNChatCash[CHAT_BUTTON_NUMBER4];					// 채팅 채쉬충전 버튼
	CINFImage	*	m_pNChatCheck;										// 채팅 채크마크
	CINFImage	*	m_pNChatFAQ[CHAT_BUTTON_NUMBER3];					// 채팅 FAQ버튼
	CINFImage	*	m_pNChatMenu[CHAT_MENULIST_NUMBER];					// 채팅 메뉴 리스트
	CINFImage	*	m_pNChatMenuView[CHAT_BUTTON_NUMBER3];				// 채팅 메뉴 보이기 버튼
	CINFImage	*	m_pNChatCashView[CHAT_BUTTON_NUMBER4];				// 채팅 메뉴 보이기 버튼
	// 2006-03-16 by ispark
	CINFImage	*	m_pNChatInputLanguage[INPUT_LANGUAGE_END];			// 입력 언어
	...
	INT				m_nMacroX;
	INT				m_nMacroY;
	CINFImage	*	m_pChatMacroBG;										// 매크로 배경 이미지.
	...
	CINFImage	*	m_pNChatVOIPStartMenu[CHAT_BUTTON_NUMBER3];			// 채팅 VOIP 시작 버튼
	CINFImage	*	m_pNChatVOIPEndMenu[CHAT_BUTTON_NUMBER3];			// 채팅 VOIP 종료 버튼
