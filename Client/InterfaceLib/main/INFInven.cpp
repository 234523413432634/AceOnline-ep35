...
HRESULT CINFInven::InitDeviceObjects()
{
	...
	m_pEqip = new CINFImage;
	pDataHeader = FindResource("equip");
	m_pEqip->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

		m_pInven = new CINFImage;
	pDataHeader = FindResource("inven");
	m_pInven->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

		m_pItemSl = new CINFImage;
	pDataHeader = FindResource("itemsl");
	m_pItemSl->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

		m_pSpi = new CINFImage;
	pDataHeader = FindResource("spi");
	m_pSpi->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;	

		m_pScrollLine = new CINFImage;
	pDataHeader = FindResource("scrline");
	m_pScrollLine->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
