...
private:
	...
	CINFImage*			m_pImgWarDeclareBG;			// 백그라운드
	
	CINFImageBtn*		m_pCalendarLeftBtn;			// 달력 왼쪽 버튼
	CINFImageBtn*		m_pCalendarRightBtn;		// 달력 오른쪽 버튼
	
	CINFImage*			m_pCalendarRect;			// 달력에 뿌릴 사각형
	CINFImage*			m_pCalendarCheck;			// 달력에 선전포고 v표시
	...
	CINFImage*			m_pANIWhiteFlag;			// 알링턴 포기 깃발
	CINFImage*			m_pBCUWhiteFlag;			// 바이젠 포기 깃발
	CINFImage*			m_pANICombatFlag;			// 알링턴 전쟁 깃발
	CINFImage*			m_pBCUCombatFlag;			// 바이젠 전쟁 깃발
