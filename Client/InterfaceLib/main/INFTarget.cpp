...
//	m_pTargetDirArrow->InitDeviceObjects();	
	...
	if(pDataHeader)
	{
		m_pTargetDirArrow[0] = new CINFImage;
		m_pTargetDirArrow[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("tgarrow2");
	if(pDataHeader)
	{
		m_pTargetDirArrow[1] = new CINFImage;
		m_pTargetDirArrow[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("tgarrow3");
	if(pDataHeader)
	{
		m_pTargetDirArrow[2] = new CINFImage;
		m_pTargetDirArrow[2]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	// 2010. 03. 03 by ckPark 인피니티 필드 2차(입장 UI변경)
	pDataHeader = FindResource("tgarrow4");
	if(pDataHeader)
	{
		m_pTargetDirArrow[3] = new CINFImage;
		m_pTargetDirArrow[3]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	// end 2010. 03. 03 by ckPark 인피니티 필드 2차(입장 UI변경)
	...
	if(pDataHeader)
	{
		m_pImgArrowHelp = new CINFImage;
		m_pImgArrowHelp->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);
	}
	...
	if(pDataHeader)
	{
		m_pRedMouse = new CINFImage;
		m_pRedMouse->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_2st_l");
	if(pDataHeader)
	{
		m_p2stLockOn = new CINFImage;
		m_p2stLockOn->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_m_whi");
	if(pDataHeader)
	{
		m_pArrowMouse = new CINFImage;
		m_pArrowMouse->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_center0");
	if(pDataHeader)
	{
		m_pCenter[0] = new CINFImage;
		m_pCenter[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_center1");
	if(pDataHeader)
	{
		m_pCenter[1] = new CINFImage;
		m_pCenter[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_text_l");
	if(pDataHeader)
	{
		m_pTextLockOn = new CINFImage;
		m_pTextLockOn->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_hp");
	if(pDataHeader)
	{
		m_pHP = new CINFImage;
		m_pHP->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_hpbox");
	if(pDataHeader)
	{
		m_pHPBox = new CINFImage;
		m_pHPBox->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}	
	...
	if(pDataHeader)
	{
		m_pBlueMouse = new CINFImage;
		m_pBlueMouse->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("arrow_w1");
	if(pDataHeader)
	{
		m_pWisperBoxLeftTRightB = new CINFImage;
		m_pWisperBoxLeftTRightB->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("arrow_w2");
	if(pDataHeader)
	{
		m_pWisperBoxLeftBRightT = new CINFImage;
		m_pWisperBoxLeftBRightT->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("arrow_w3");
	if(pDataHeader)
	{
		m_pWisperBoxLeftRight = new CINFImage;
		m_pWisperBoxLeftRight->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("arrow_w4");
	if(pDataHeader)
	{
		m_pWisperBoxTopBottom = new CINFImage;
		m_pWisperBoxTopBottom->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("arrow_w5");
	if(pDataHeader)
	{
		m_pWisperBoxCross = new CINFImage;
		m_pWisperBoxCross->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_ototar");
	if(pDataHeader)
	{
		m_pAutoTarget = new CINFImage;
		m_pAutoTarget->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_oto");
	if(pDataHeader)
	{
		m_pAutoTargetLong = new CINFImage;
		m_pAutoTargetLong->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("arrow1");
	if(pDataHeader)
	{
		m_pNormalMouse[0] = new CINFImage;
		m_pNormalMouse[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("arrow2");
	if(pDataHeader)
	{
		m_pNormalMouse[1] = new CINFImage;
		m_pNormalMouse[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("skTarget");
	if(pDataHeader)
	{
		m_pSkillTarget = new CINFImage;
		m_pSkillTarget->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_angle");
	if(pDataHeader)
	{
		m_pFireAngle[0] = new CINFImage;
		m_pFireAngle[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_angle1");
	if(pDataHeader)
	{
		m_pFireAngle[1] = new CINFImage;
		m_pFireAngle[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("t_mon");
	if(pDataHeader)
	{
		m_pMonTargetStateImg = new CINFImage;
		m_pMonTargetStateImg->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}

	pDataHeader = FindResource("attmonr");
	if(pDataHeader)
	{
		m_pImgTargetMe[0] = new CINFImage;
		m_pImgTargetMe[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	...
	for(int i=0; i<4; i++)
	{
		...
		m_pImgTargetAnimation[i] = new CINFImage;
		m_pImgTargetAnimation[i]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("mest");
	if(pDataHeader)
	{
		m_pImgTargetHelper[0] = new CINFImage;
		m_pImgTargetHelper[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("mesp");
	if(pDataHeader)
	{
		m_pImgTargetHelper[1] = new CINFImage;
		m_pImgTargetHelper[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	...
	if(pDataHeader)
	{
		m_pImgTargetMe[1] = new CINFImage;
		m_pImgTargetMe[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}

	pDataHeader = FindResource("1st_R");
	if(pDataHeader)
	{
		m_pImgSelectTarget[0] = new CINFImage;
		m_pImgSelectTarget[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}

	pDataHeader = FindResource("1st_L");
	if(pDataHeader)
	{
		m_pImgSelectTarget[1] = new CINFImage;
		m_pImgSelectTarget[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	pDataHeader = FindResource("p1st_R");
	if(pDataHeader)
	{
		m_pImgPartyTarget[0] = new CINFImage;
		m_pImgPartyTarget[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}

	pDataHeader = FindResource("p1st_L");
	if(pDataHeader)
	{
		m_pImgPartyTarget[1] = new CINFImage;
		m_pImgPartyTarget[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	...
	if(pDataHeader)
	{
		m_pImgFriendlyTarget[0] = new CINFImage;
		m_pImgFriendlyTarget[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	
	pDataHeader = FindResource("1stb_L");
	if(pDataHeader)
	{
		m_pImgFriendlyTarget[1] = new CINFImage;
		m_pImgFriendlyTarget[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;
	}
	// end 2010. 03. 03 by ckPark 인피니티 필드 2차(입장 UI변경)
