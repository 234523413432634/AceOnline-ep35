...
HRESULT CINFTrade::InitDeviceObjects()
{
	...
	DataHeader	* pDataHeader;
		...
		m_pTradeOkButton[0] = new CINFImage;
	pDataHeader = FindResource("sok0");
	m_pTradeOkButton[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

		m_pTradeOkButton[1] = new CINFImage;
	pDataHeader = FindResource("sok1");
	m_pTradeOkButton[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

		m_pTradeOkButton[2] = new CINFImage;
	pDataHeader = FindResource("sok2");
	m_pTradeOkButton[2]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

// 2005-09-20 by ispark
		m_pTradeCancelButton[0] = new CINFImage;
	pDataHeader = FindResource("glcan00");
	m_pTradeCancelButton[0]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

		m_pTradeCancelButton[1] = new CINFImage;
	pDataHeader = FindResource("glcan01");
	m_pTradeCancelButton[1]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

		m_pTradeCancelButton[2] = new CINFImage;
	pDataHeader = FindResource("glcan02");
	m_pTradeCancelButton[2]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

		m_pTralog = new CINFImage;
	pDataHeader = FindResource("tra_log");
	m_pTralog->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

		m_pTrame = new CINFImage;
	pDataHeader = FindResource("tra_me");
	m_pTrame->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

		m_pTrayou = new CINFImage;
	pDataHeader = FindResource("tra_you");
	m_pTrayou->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;	

	// 2008-11-21 by bhsohn 거래 완료 시스템 처리	
	m_pTrameComple = new CINFImage;
	pDataHeader = FindResource("tra_me1");
	m_pTrameComple->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;

	m_pTrayouComple = new CINFImage;
	pDataHeader = FindResource("tra_you1");
	m_pTrayouComple->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize) ;	
	// end 2008-11-21 by bhsohn 거래 완료 시스템 처리
