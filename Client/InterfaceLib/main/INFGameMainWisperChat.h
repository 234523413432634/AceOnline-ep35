...
public:
	...
	CINFImage					*m_pWhisperBox[9];												// 귓말 박스 이미지
	...
	CINFImage					*m_pWhisperBoxTextInput[3];										// 귓말 박스 이미지
...
public:
	...
	CINFImage					*m_pSystemBox[9];												// 귓말 박스 이미지
	CINFImage					*m_pSystemBoxMin;												// 귓말 박스 이미지
	CINFImage					*m_pSystemBoxClose;												// 귓말 박스 이미지
	CINFImage					*m_pSystemBoxName;												// 시스템 박스 이름. 
