...
private:
	...
	void RenderTime();
private:
	CINFImage*	m_pArenaScoreBk[MAX_ARENA_SCOREMODE];	
	int			m_nScoreMode;

	// 각 진형 숫자
	CINFImage*	m_pArenaScoreNum[MAX_ARENA_INFLUENCE][MAX_ARENA_NUM];	

	// 진형 정보
	CINFImage*	m_pArenaInfluence[MAX_ARENA_INFLUENCE];

	// 시간 정보 
	CINFImage*	m_pArenaTime[MAX_ARENA_TIME][MAX_ARENA_NUM];
