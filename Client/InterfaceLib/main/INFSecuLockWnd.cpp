...
HRESULT CINFSecuLockWnd::InitDeviceObjects()
{
...

	{
		if(NULL == m_pLockBk)
		{
			m_pLockBk = new CINFImage;
		}
		wsprintf(buf,"se_lbk");
		pDataHeader = g_pGameMain->FindResource(buf);
		m_pLockBk->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);		
	}

	{
		char szUpBtn[30], szDownBtn[30], szSelBtn[30], szDisBtn[30];		
		wsprintf(szUpBtn, "se_lbtn0");
		wsprintf(szDownBtn, "se_lbtn1");
		wsprintf(szSelBtn, "se_lbtn3");
	...
	{
		char szUpBtn[30], szDownBtn[30], szSelBtn[30], szDisBtn[30];		
		wsprintf(szUpBtn, "se_ulbtn0");
		wsprintf(szDownBtn, "se_ulbtn1");
		wsprintf(szSelBtn, "se_ulbtn3");
	...
	{
		char szUpBtn[30], szDownBtn[30], szSelBtn[30], szDisBtn[30];		
		wsprintf(szUpBtn, "se_pbtn0");
		wsprintf(szDownBtn, "se_pbtn1");
		wsprintf(szSelBtn, "se_pbtn3");
	...
	{
		char szUpBtn[30], szDownBtn[30], szSelBtn[30], szDisBtn[30];		
		wsprintf(szUpBtn, "sel_pcbtn0");
		wsprintf(szDownBtn, "sel_pcbtn1");
		wsprintf(szSelBtn, "sel_pcbtn3");
