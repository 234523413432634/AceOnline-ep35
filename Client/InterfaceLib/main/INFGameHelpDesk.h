...
public:
	...
	CINFImage*					m_pLowLevelHelpflash;					// 2006-08-22 by ispark
...
protected:
	...
	CINFImage*					m_pHelpBox[9];				// 도움말 상자
	CINFImage*					m_pHelpButton[8];			// 도움말 버튼
	CINFImage*					m_pHelpButtonNPC[2];		// 미션과 닫기 버튼	
	CINFImage*					m_pHelpKeyImage[5];			// 도움말 키보드 이미지
	CINFImage*					m_pHelpMouseImage[8];		// 도움말 마우스 이미지
	CINFImage*					m_pHelpKeyImage2[8];		// 도움말 키보드 이미지
	...
	CINFImage*					m_pLowLevelHelpBox;			// 2006-08-22 by ispark
