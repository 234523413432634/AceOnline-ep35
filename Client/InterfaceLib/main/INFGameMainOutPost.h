...
public:
	...
	CINFImage*		m_pImgProDestroy;								// 방어막 파괴.
	CINFImage*		m_pImgResetStart;								// 각인 시작.
	CINFImage*		m_pImgResetSucc;								// 각인 성공.
	CINFImage*		m_pImgResetDestroy;								// 각인 파괴.
	CINFImage*		m_pImgResetBarBack;								// 리셋바 배경.
	CINFImage*		m_pImgResetBarBar1;								// 리셋바1(빨강:공격)
	CINFImage*		m_pImgResetBarBar2;								// 리셋바2(파랑:방어)
	CINFImage*		m_pImgResetBarInf1;								// 리셋바세력 1.(바이제니유)
	CINFImage*		m_pImgResetBarInf2;								// 리셋바세력 2.(알링턴)
