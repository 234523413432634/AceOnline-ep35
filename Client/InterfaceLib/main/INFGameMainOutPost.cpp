...
HRESULT CINFGameMainOutPost::InitDeviceObjects()
{
	...
	m_pImgProDestroy = new CINFImage;
	m_pImgProDestroy->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );

	pDataHeader = FindResource("usconre");
	m_pImgResetStart = new CINFImage;
	m_pImgResetStart->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );

	pDataHeader = FindResource("usoutPre");
	m_pImgResetSucc = new CINFImage;
	m_pImgResetSucc->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );

	pDataHeader = FindResource("usconruin");
	m_pImgResetDestroy = new CINFImage;
	m_pImgResetDestroy->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );
	
	pDataHeader = FindResource("outpback");
	m_pImgResetBarBack = new CINFImage;
	m_pImgResetBarBack->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );

	pDataHeader = FindResource("outpbar1");
	m_pImgResetBarBar1 = new CINFImage;
	m_pImgResetBarBar1->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );

	pDataHeader = FindResource("outpbar2");
	m_pImgResetBarBar2 = new CINFImage;
	m_pImgResetBarBar2->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );

	pDataHeader = FindResource("outpinf1");
	m_pImgResetBarInf1 = new CINFImage;
	m_pImgResetBarInf1->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );

	pDataHeader = FindResource("outpinf2");
	m_pImgResetBarInf2 = new CINFImage;
	m_pImgResetBarInf2->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );
