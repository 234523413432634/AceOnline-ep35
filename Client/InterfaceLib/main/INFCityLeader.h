...
private:
	...
	CINFImage*			m_pImgBrigadeNoticeB[BUTTON_STATE_NUMBER];
	CINFImage*			m_pImgDelB[BUTTON_STATE_NUMBER];
	CINFImage*			m_pImgExpenceB[BUTTON_STATE_NUMBER];
	CINFImage*			m_pImgWriteB[BUTTON_STATE_NUMBER];
	CINFImage*			m_pImgRevB[BUTTON_STATE_NUMBER];
	CINFImage*			m_pImgTitle;
	CINFImage*			m_pImgOutPostLBG;
	CINFImage*			m_pImgBriNoticeBG;
	//CINFImage*			m_pImgOutPostTimeSetBG;
	CINFImage*			m_pImgExpenceBG;
	...
	CINFImage*			m_pImgAniBG;										// 알링턴 배경.
	CINFImage*			m_pImgVniBG;										// 바이제니유 배경.
	CINFImage*			m_pImgAppBG;										// 공약 작성 배경.
	...
	CINFImage*			m_pImgPInfoBG;										// 후보 정보 배경.
	CINFImage*			m_pImgListBG;										// 리스트 배경.
	CINFImage*			m_pImgRSelect;										// 선택한 리스트.
	CINFImage*			m_pImgPollDateABG;									// 알링턴 선거 일자 배경.
	CINFImage*			m_pImgPollDateVBG;									// 바이제니유 선거 일자 배경.
	CINFImage*			m_pImgRSelectB[2][BUTTON_BOTH_STATE_NUMBER];		// 선택(목록) 버튼(앞뒤)
	...
	// 전장정보창.
	CINFImage*			m_pImgWarInfoBG[LEADER_WARINFO_END];				// 탭 배경들.
	CINFImage*			m_pImgWarInfoInflAni;								// 알링턴 배경.
	CINFImage*			m_pImgWarInfoInflBcu;								// 바이제니유 배경.
