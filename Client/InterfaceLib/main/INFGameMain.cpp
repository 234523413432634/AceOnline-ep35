...
// 튜토리얼 버튼 추가
#define TUTORIAL_BUTTON_X		(g_pD3dApp->GetBackBufferDesc().Width - 64)
#define TUTORIAL_BUTTON_Y		315
...
//	m_pShop->InitDeviceObjects() ;
	...
	//m_pChat = new CINFGameMainChat(this);
...
//	m_pNotice->InitDeviceObjects() ;
	...
	if ( pDataHeader )
	{
		m_pImgTextBg = new CINFImage;
		m_pImgTextBg->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );
	}

	pDataHeader = m_pGameData->Find( "mnbtn70" );
	m_pImgMission = new CINFImage;
	m_pImgMission->InitDeviceObjects( pDataHeader->m_pData, pDataHeader->m_DataSize );

	pDataHeader = m_pGameData->Find("mnbtn71");
	m_pImgStack = new CINFImage;
	m_pImgStack->InitDeviceObjects(pDataHeader->m_pData, pDataHeader->m_DataSize);
...
//	m_pMissionInfo->InitDeviceObjects();
	...
	m_pAltiMeterGage = new CINFImage;
	pDataHeader = FindResource("altig");
	m_pAltiMeterGage->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);	

	m_pAltiMeterPin = new CINFImage;
	pDataHeader = FindResource("altip");
	m_pAltiMeterPin->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);
...
// 2009-02-03 by bhsohn 장착 아이템 비교 툴팁
//void CINFGameMain::SetItemInfo(LONGLONG nUniqueNumber, int nItemNum, int x, int y, int nItemCount)
...
void CINFGameMain::ToggleHelpImage()
{
	...
	if(m_bShowHelp)
	{
		for(int i=0;i<HELP_NUM;i++)
		{
			...
			m_pHelp[i] = new CINFImage;
			DataHeader * pDataHeader = FindResource(buf);
			m_pHelp[i]->InitDeviceObjects(pDataHeader->m_pData,pDataHeader->m_DataSize);
			m_pHelp[i]->RestoreDeviceObjects();
		}
	}
	else
...
// 	CINFImage* pIcon = m_pIcon->FindIcon(buf);
	...
	CINFImage* pIcon = m_pIcon->FindIcon( szIconName );
	// end 2009. 08. 27 by ckPark 그래픽 리소스 변경 시스템 구현
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
CINFImage* CINFGameMain::FindIcon(char* strName)
{
...
{
	// 2011-12-13 hsson, 아레나, 인피에서 미션정보 보지 못하도록 수정
	...
	// end 2011-12-13 hsson, 아레나, 인피에서 미션정보 보지 못하도록 수정
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
void CINFGameMain::ShowShopInven(int nBuildingKind, BOOL bShowInven/*=FALSE*/)
{	
	POINT ptItem, ptEq;
...
// 2009. 11. 02 by ckPark 인피니티 필드 인스턴스 던젼 시스템
CINFImage*	CINFGameMain::FindBigIcon( int nItemnum )
{
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
void CINFGameMain::SetItemInfoUser( CItemInfo* pItemInfo, int x, int y, BOOL bShowMyEq/*=TRUE*/)
{	
	// 일반 툴팁
	m_pItemInfo->SetItemInfoUser( pItemInfo, x, y );
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
void CINFGameMain::SetItemInfoNormal( ITEM* pITEM, int x, int y, BOOL bShop, int nItemCount /*= 0*/, BOOL bShowMyEq/*=TRUE*/)
{	
