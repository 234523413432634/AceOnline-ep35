...
public:
	...
	CINFImage *				m_pImgVoice;					// 음성 통신 아이콘.
	CINFImage*				m_pImgBG;						// 이미지 배경.
	CINFImage *				m_pImgSpkVolBar;				// 음성 통신 바.
	...
	//--------------------------------------------------------------------------//
	// 채팅방 목록.
	CINFImage *				m_pImgRoomListBG;				// 채팅방 목록 배경.
	CINFImage *				m_pImgLock[2];
	CINFImage *				m_pImgSel;						// 선택 이미지.
	...
	//--------------------------------------------------------------------------//
	// 채팅방.
	CINFImage *				m_pImgRoomBg;
	CINFArenaScrollBar *	m_pScrRoom;
	CINFImage *				m_pImgChatRoomSel;
	CINFImage *				m_pImgRoomChief;				// 방장.
	...
	CINFImage			*	m_pImgRadioBtn[2];				// 래디오 버튼.
	...
	CINFImage*				m_pRoomCreateBG;				// 방생성 배경.
	...
	CINFImage *				m_pRoomInfoBG;					// 채팅방 정보창 배경.
