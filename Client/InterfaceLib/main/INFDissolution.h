...
private:
	...
	CD3DHanFont	*			m_TakeItemFont;				//
 	...
 	CINFImage*				m_pImgDissolutionBG;		// 배경
	CINFImage*				m_pImgDissolutionLogo;		// 용해 로고
	CINFImage*				m_pImgDissolutionAniBG[EFFECT_BG_MAX];			//용해 로고 애니메이션 

	CINFImage*				m_pImgDissolutionEffect[EFFECT_MAX];			// 용해 이팩트
	CINFImage*				m_pImgDissolutionTakeEffect[TAKE_EFFECT_MAX];	// 용해 받을 아이템 이팩트 
