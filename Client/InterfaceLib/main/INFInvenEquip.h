...
//	float				m_fUnitPosY;
	...
	CINFImage*			m_pWearPositionBlink;//인벤안에 있는 아이템에 마우스를 갖다 댓을때 장착창 위치에서 깜박일 이미지
	...
	CINFImage*			m_pInvenRotationBase;
	CINFImage*			m_pInvenDirection[INVEN_ROTATION_STATE][INVEN_ROTATION_NUM];
	
	CINFImage*			m_pWeight[MAX_WEIGHT];	// 적재량
