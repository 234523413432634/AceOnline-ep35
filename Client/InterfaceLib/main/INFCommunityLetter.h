...
private:
	CINFImage*		m_pBack;		// 배경
	
	// 읽기/쓰기
	int				m_nLetterMode;
	CINFImage*		m_pLetterMode[MAX_LETTER_MODE];		
	...
	CINFImage*		m_pLetterRead[MAX_LETTER_READ];		
	
	CINFImage*		m_pLetterReadListBk;		
	CINFImage*		m_pLetterReadBk;
