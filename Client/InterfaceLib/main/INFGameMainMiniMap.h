...
//	CSkinnedMesh*	m_pMeshArea;							// 2005-09-13 by ispark 별도 처리
	...
	CINFImage*		m_pImgStateWarning;						// 2005-07-08 by ispark // 유닛 미사일 경교
	CINFImage*		m_pMiniMapFrame;						// 미니맵 틀
	CINFImage*		m_pMiniMapUnitImage;					// 기어
	CINFImage*		m_pMiniMapPartyImage;					// 파티 이미지
	CINFImage*		m_pArenaMapInfImg;						// 아레나 맵에서 같은 세력을 표시해줄때.
	CINFImage*		m_pImgQuestTarget;						// 2007-02-26 by dgwoo 원표시.
