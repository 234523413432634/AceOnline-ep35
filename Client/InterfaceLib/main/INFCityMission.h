...
protected:
	...
	CINFImage*		m_pJoinButton[CITY_MISSION_BUTTON_NUMBER];
	CINFImage*		m_pCompleteButton[CITY_MISSION_BUTTON_NUMBER];
	CINFImage*		m_pCancelButton[CITY_MISSION_BUTTON_NUMBER];
