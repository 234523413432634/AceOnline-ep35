...
private:
	CINFImage*	m_pArenaResultBk[MAX_ARENA_RESULTMODE];	
	CINFImage*	m_pArenaResultInfluence[MAX_ARENA_RESULTINFLUENCE];		// 진형 
	CINFImage*	m_pArenaResultState[MAX_ARENA_RESULTSTATE];		// 진형 	
