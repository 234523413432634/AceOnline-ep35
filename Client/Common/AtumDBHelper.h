...
public:
	...
	static int LoadMysteryItemDropInfo(mmapINT2MYSTERY_ITEM_DROP *o_pmmapMysteryItemDropList, CODBCStatement *i_pODBCStmt, ez_map<INT, ITEM*> *i_pemapItemInfoList, int i_nMGServerID);		// 2007-05-11 by cmkwon
	...
	// END 2010-06-15 by shcho&hslee 펫시스템 - DB 밀기 추가 작업 펫 오퍼레이터 정보.
...
// 	static int SaveInfluenceRate(CODBCStatement *i_pODBCStmt, vectSTI_INFLUENCERATE *o_pInfluenceRate);		// 2009-09-16 by cmkwon, 세력 초기화시 어뷰징 방지 구현 - ti_InfluenceRate 테이블 추가, 
	...
	static int SaveItemMixingInfo(CODBCStatement *i_pODBCStmt, vector<ITEM_MIXING_INFO> *o_pMapItemMixingInfo, HWND hWnd);
...
#define CB_COUNT_MONSTER			57	// # of fields + 1	// 2010-04-14 by cmkwon, 인피2차 몬스터 랜텀 타겟 변경 처리 - ChangeTargetTime 필드 추가, // 2010-03-31 by dhjin, 인피니티(기지방어) - 54 -> 56 // 2009-09-09 ~ 2010 by dhjin, 인피니티 - 41 -> 54으로 수정, // 2007-09-05 by dhjin	
...
#define CB_COUNT_ti_ItemMixingInfo             		14
...
#define CB_COUNT_ti_Pet								6			// 2010-06-15 by shcho&hslee 펫시스템 - 팻 기본 정보 엑셀 밀기
#define CB_COUNT_ti_petLevel						13			// 2010-06-15 by shcho&hslee 펫시스템 - 팻 레벨 정보 엑셀 밀기
