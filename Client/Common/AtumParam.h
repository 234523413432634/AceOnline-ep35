...
#define LANGUAGE_TYPE_GERMAN			5			// 2008-04-25 by cmkwon, Áö¿ø ¾ð¾î¿¡ µ¶ÀÏ¾î Ãß°¡ - ¾ð¾î Á¤ÀÇ Ãß°¡, Gameforge4D_Deu
#define LANGUAGE_TYPE_THAI				6			// 2008-04-11 by cmkwon, Áö¿ø ¾ð¾î Ãß°¡ - ÅÂ±¹¾î(Thai - Tha)
#define LANGUAGE_TYPE_RUSSIAN			7			// 2008-04-11 by cmkwon, Áö¿ø ¾ð¾î Ãß°¡ - ·¯½Ã¾Æ¾î(Russian - Rus)
#define LANGUAGE_TYPE_TAIWANESE			8			// 2008-09-02 by cmkwon, Áö¿ø ¾ð¾î Ãß°¡(´ë¸¸¾î Taiwanese - Tpe) - 
#define LANGUAGE_TYPE_TURKISH			9			// 2008-10-20 by cmkwon, Áö¿ø ¾ð¾î Ãß°¡(ÅÍÅ°¾Æ, ºÒ¾î, ÀÌÅ»¸®¾Æ¾î) - 
#define LANGUAGE_TYPE_FRENCH			10			// 2008-10-20 by cmkwon, Áö¿ø ¾ð¾î Ãß°¡(ÅÍÅ°¾Æ, ºÒ¾î, ÀÌÅ»¸®¾Æ¾î) - 
#define LANGUAGE_TYPE_ITALIAN			11			// 2008-10-20 by cmkwon, Áö¿ø ¾ð¾î Ãß°¡(ÅÍÅ°¾Æ, ºÒ¾î, ÀÌÅ»¸®¾Æ¾î) - 
#define LANGUAGE_TYPE_POLISH			12			// 2009-03-17 by cmkwon, Áö¿ø ¾ð¾î Ãß°¡(Æú¶õµå¾î, ½ºÆäÀÎ¾î) - Gameforge4D_Pol(PL)
#define LANGUAGE_TYPE_SPANISH			13			// 2009-03-17 by cmkwon, Áö¿ø ¾ð¾î Ãß°¡(Æú¶õµå¾î, ½ºÆäÀÎ¾î) - Gameforge4D_Esp(ES)
#define LANGUAGE_TYPE_ARGENTINA			14			// 2010-11-01 by shcho, Lin ¾Æ¸£ÇîÆ¼³ª ¼­ºñ½º ½ÃÀÛ ÁØºñ - ¾ð¾îÁ¤ÀÇ Ãß°¡
#define LANGUAGE_TYPE_INDONESIA			15			// 2010-01-11 by shcho,	 Áö¿ø ¼­ºñ½º Ãß°¡(WinnerOnline ÀÎµµ³×½Ã¾Æ¾î) -

#define LANGUAGE_TYPE_LAST				LANGUAGE_TYPE_INDONESIA		// 2009-03-17 by cmkwon, Áö¿ø ¾ð¾î Ãß°¡(Æú¶õµå¾î, ½ºÆäÀÎ¾î) - 
...
#define IS_VALID_LANGUAGE_TYPE(_lang)	((_lang) >= LANGUAGE_TYPE_KOREAN && (_lang) <= LANGUAGE_TYPE_LAST)	// 2008-04-11 by cmkwon, Áö¿ø ¾ð¾î Ãß°¡ - 

extern char *GET_LANGUAGE_TYPE_STRING(int i_nLangTy);	// 2008-04-25 by cmkwon, Áö¿ø ¾ð¾î¿¡ µ¶ÀÏ¾î Ãß°¡ - Gameforge4D_Deu Ãß°¡

// 2009-12-28 by cmkwon, ¸¶»óÈ¸»ç IP º¯°æ - ±âÁ¸(121.134.114.)
#define MASANG_PREFIX_IP1				"61.39.170."			// 2010-01-18 by cmkwon, ¸¶»ó ¼­ÃÊ »ç¹«½Ç, // 2007-01-03 by cmkwon, MasangSoft ³²ºÎÅÍ¹Ì³Î·Î ÀÌÀü
#define MASANG_PREFIX_IP2				"222.99.72."			// 2010-01-18 by cmkwon, ¸¶»ó ºÐ´ç »ç¹«½Ç, // 2009-03-02 by cmkwon, ³»ºÎ Å×¼·¿¡¼­ Ä³½¬ Æ÷ÀÎÆ® °ü·Ã ¼öÁ¤(µð¹ö±× ¸ðµå½Ã¸¸ µ¿ÀÛ) - 2·Î ¼öÁ¤, // 2007-01-03 by cmkwon, MasangSoft ³²ºÎÅÍ¹Ì³Î·Î ÀÌÀü
...
typedef BYTE		DestParam_t;		// DestParam Type	// 2009-09-09 ~ 2010-02-10 by dhjin, ÀÎÇÇ´ÏÆ¼ - ¹ßµ¿·ùÀåÂø¾ÆÀÌÅÛ
...
#define SIZE_MAX_PARTY_MEMBER					6			// ÃÖ´ë ÆÄÆ¼¿ø ¼ö
...
#define IS_OUTPOST_CITY_MAP_INDEX(__MAP_INDEX)		(2004 == (__MAP_INDEX) || 2005 == (__MAP_INDEX) || 2006 == (__MAP_INDEX))		// 2008-09-10 by dhjin, 2006Ãß°¡ Â÷ÈÄ MAP_INFLUENCE_OUTPOST = 6000°ªÀ¸·Î º¯°æÇØ¾ßÇÒµíÇÏ´Ù.	// 2007-09-10 by dhjin, ÀüÁø±âÁö µµ½Ã¸Ê ÀÎ°¡? 
...
#define ADD_WARPOINT_STRATEGYPOINT_MONSTER					300			// 2007-09-06 by dhjin 100=>300, // 2007-05-15 by dhjin, Àü·«Æ÷ÀÎÆ® ÆøÆÄ/¹æ¾î ¼º°ø½Ã Áõ°¡ WARPOINT 
#define ADD_WARPOINT_BOSS_MONSTER							500			// 2007-09-06 by dhjin 300=>500, // 2007-05-15 by dhjin, ¸ð¼± ÆøÆÄ/¹æ¾î ¼º°ø½Ã Áõ°¡ WARPOINT
#define ADD_WARPOINT_STRATEGYPOINT_MONSTER_BY_LOSE			100			// 2008-01-07 by dhjin, ¼¼·Â º¸»ó ¼öÁ¤ - Àü·«Æ÷ÀÎÆ® ÆøÆÄ/¹æ¾î ÆÐ¹è½Ã Áõ°¡ WARPOINT 
#define ADD_WARPOINT_BOSS_MONSTER_BY_LOSE					200			// 2008-01-07 by dhjin, ¼¼·Â º¸»ó ¼öÁ¤ - ¸ð¼± ÆøÆÄ/¹æ¾î ÆÐ¹è½Ã Áõ°¡ WARPOINT
...
// 2008-12-18 by cmkwon, ÀÏº» Arario ¿ÜºÎÀÎÁõ, ºô¸µ ¸ðµâ Àû¿ëÇÏ±â - ¾Æ·¡¿Í °°ÀÌ ÀÏº»¸¸ »çÀÌÁî¸¦ ´Ù¸£°Ô ÇÑ´Ù.
...
#define SIZE_MAX_WEBLOGIN_AUTHENTICATION_KEY				301				// 2008-12-18 by cmkwon, ÀÏº» Arario ¿ÜºÎÀÎÁõ, ºô¸µ ¸ðµâ Àû¿ëÇÏ±â - ¼¼¼ÇÅ°°¡ Àü´Þ°ÍÀÓ. AUTH_SESSIONKEY_LEN + 1 Å©±â°¡ ÇÊ¿ä
#else
#define SIZE_MAX_WEBLOGIN_AUTHENTICATION_KEY				30				// 2007-03-29 by cmkwon, À¥ÀÎÁõÅ° ÃÖ´ë ½ºÆ®¸µ »çÀÌÁî(ÇöÀç´Â ¿¹´ç¸¸ »ç¿ë ¿¹Á¤)
#endif
...
#define IS_MAP_INFLUENCE_OUTPOST(mapInfl)		( MAP_INFLUENCE_OUTPOST_START <= (mapInfl) && MAP_INFLUENCE_OUTPOST_LAST >= (mapInfl) )	// ÀüÁø±âÁö ¸Ê(6000 ~ 6999)ÀÎ°¡?
...
#define IS_TELEPORT_MONSTER(monBell)			( ((monBell) >= BELL_INFLUENCE_TELEPORT_VCN) && ((monBell) <= BELL_INFLUENCE_TELEPORT_ANI) )	// 2007-09-19 by dhjin, ÅÚ·¹Æ÷Æ® Ã¼Å©
...
//						- ¿ÜÇü º¯°æ °¡´É Kind ÃÑ 5Á¾, 1Çü/2Çü ¹«±â, ¸¶Å©, ¾Æ¸Ó, ·¹ÀÌ´õ
...
{	// ÆÄÆ®³Ê(ÆÖ) Å¸ÀÔ ¿­°ÅÀÚ.
	...
	PARTNER_TYPE_NORMAL = 0,		// ÀÏ¹ÝÇü.

	PARTNER_TYPE_ATT = 1,			// °ø°ÝÇü.
	PARTNER_TYPE_DEF ,				// ¹æ¾îÇü.
	PARTNER_TYPE_BUFF ,				// ¹öÇÁÇü.
	PARTNER_TYPE_STORE ,			// °³ÀÎ»óÁ¡Çü.
...
#define DES_SKILL_STOPMAGIC					152		// 		¹Ì±¸Çö - ÀûÀÇ ½ºÅ³À» ÀÏÁ¤½Ã°£ »ç¿ë±ÝÁö½ÃÅ²´Ù.
...
///////////////////////////////////////////////////////////////////////////////
// 2009-08-26 by cmkwon, ±×·¡ÇÈ ¸®¼Ò½º º¯°æ ½Ã½ºÅÛ ±¸Çö - 
#define DES_SHAPE_ITEM								194		// Á¶ÇÕ½Ã ¼Ò½º ¾ÆÀÌÅÛÀÇ ShapeItemNumÀ» º¯°æ ÇÒ Item, LinkItemÀ» »ç¿ë
#define DES_EFFECT_ITEM								195		// Á¶ÇÕ½Ã ¼Ò½º ¾ÆÀÌÅÛÀÇ EffectItemNumÀ» º¯°æ ÇÒ Item, ÇØ´ç ItemNumÀ» »ç¿ë 
...
#define DES_INIT_SHAPE_ITEM							197		// Á¶ÇÕ½Ã ¼Ò½º ¾ÆÀÌÅÛÀÇ ShapeItemNumÀ» ÃÊ±âÈ­ ÇÒ Item
#define DES_INIT_EFFECT_ITEM						198		// Á¶ÇÕ½Ã ¼Ò½º ¾ÆÀÌÅÛÀÇ EffectItemNumÀ» ÃÊ±âÈ­ ÇÒ Item
...
// 	float		ParameterValue4;				// ¼öÁ¤ÆÄ¶ó¹ÌÅÍ4
	...
	BOOL IsExistDesParam(BYTE desParam)
	{
...
// 		}
	...
	float GetParameterValue(BYTE i_destParam)
	{
// 2009-04-21 by cmkwon, ITEM¿¡ DesParam ÇÊµå °³¼ö 8°³·Î ´Ã¸®±â - ¾Æ·¡¿Í °°ÀÌ ¼öÁ¡ÇÔ
...
struct SCASH_PREMEIUM_CARD_INFO
{
	...
	void ResetAllPlusRateByPremiumCard(int i_nLangTy)
	{
		...
		case LANGUAGE_TYPE_CHINESE:
			{// 2007-11-06 by cmkwon, Áß±¹¿¡µµ ¸â¹ö½± ÇýÅÃ Ãß°¡ - °æÇèÄ¡ 15%
				fExpRate			= 0.15f;
			}
			break;
		case LANGUAGE_TYPE_TAIWANESE:
			{// 2008-12-15 by cmkwon, ´ë¸¸ Netpower_tpe ¿¡ ¸â¹ö½± Ãß°¡ ÇýÅÃ(°æÇèÄ¡ 20%) Ãß°¡ - 
				fExpRate			= 0.2f;
			}
			break;
		}
// 2007-11-06 by cmkwon, Áß±¹¿¡µµ ¸â¹ö½± ÇýÅÃ Ãß°¡ - À§¿Í °°ÀÌ ¼öÁ¤ ÇÔ
...
Err_t GCheckExcuteParameterList_Eng_Server_2(SEXCUTE_PARAMETER *io_pExeParam);		// 2007-12-21 by cmkwon, Gameforge(Europe) ÇÁ·ÎÁ§Æ® Ãß°¡ - GCheckExcuteParameterList_Eng_Server_2() Ãß°¡
...
Err_t GCheckExcuteParameterList_Tha(SEXCUTE_PARAMETER *io_pExeParam);		// 2008-05-02 by cmkwon, WinnerOnline_Tha Ãß°¡ÇÏ±â - 
Err_t GCheckExcuteParameterList_Rus(SEXCUTE_PARAMETER *io_pExeParam);		// 2008-05-29 by cmkwon, Áö¿ø ¼­ºñ½º Ãß°¡(Innova_Rus ·¯½Ã¾Æ¾î Ãß°¡) - 
Err_t GCheckExcuteParameterList_Tpe(SEXCUTE_PARAMETER *io_pExeParam);		// 2008-09-23 by cmkwon, Áö¿ø ¼­ºñ½º Ãß°¡(´ë¸¸ Netpower_Tpe) - 
Err_t GCheckExcuteParameterList_Jpn(SEXCUTE_PARAMETER *io_pExeParam);		// 2008-12-03 by cmkwon, Áö¿ø ¼­ºñ½º Ãß°¡(ÀÏº» Arario_Jpn) - 
...
#define ARENA_STAGE_A_END_LEVEL				110	// ÀÔÀå°¡´ÉÇÑ A¹æ ¸¶Áö¸··¹º§ 100
...
#define	OUTPOST_PAY_WARPOINT			300	// ÀüÁø±âÁöÀü ½Â¸® ¼¼·Â Áö±Þ WarPoint
#define	OUTPOST_PAY_WARPOINT_BY_LOSE	100	// 2008-01-07 by dhjin, ¼¼·Â º¸»ó ¼öÁ¤ - ÀüÁø±âÁöÀü ÆÐ¹è ¼¼·Â Áö±Þ WarPoint
...
///////////////////////////////////////////////////////////////////////////////
// 2009-01-23 by cmkwon, ÅÍÅ° i,I ¹®ÀÚ ¹®Á¦ Ã³¸® - LowercaseOnly_i_forTurkish() Ãß°¡, ÅÍÅ° ¼­ºñ½º¸¸ i¹®ÀÚ¸¸ ¼Ò¹®ÀÚ·Î º¯°æ
...
#define CHARACTER_LEVEL_110					125
