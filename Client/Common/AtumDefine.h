...
#define GUI_FONT_COLOR						RGB(222, 222, 222)		// 기본 색상(흰색) white
#define GUI_SELECT_FONT_COLOR				RGB(1, 1, 1)			// 선택 색상(검은색) black
#define GUI_FONT_COLOR_YM					RGB(255, 168, 0)		// 기본 색상(주황색) orange
#define GUI_FONT_COLOR_BM					RGB(178, 190, 255)		// 기본 색상(연한하늘색) light blue
#define GUI_FONT_COLOR_Y					RGB(255, 255, 0)		// 기본 색상(노란색) yellow
#define GUI_FONT_COLOR_R					RGB(255, 0, 0)			// 기본 색상(빨간색) red
#define GUI_FONT_COLOR_G					RGB(128, 128, 128)		// 기본 색상(회색색) green
#define GUI_FONT_COLOR_B					RGB(0, 0, 255)			// 기본 색상(파란색) blue
#define GUI_FONT_COLOR_W					RGB(255, 255, 255)		// 기본 색상(흰색) white
#define GUI_FONT_COLOR_GR					RGB(211, 211, 211)		// 기본 색상(회색) gray
...
#define	INVEN_RESOLUTION_7				3440
...
#define INVEN_RESOLUTION_WINDOW_1600	1594
#define INVEN_RESOLUTION_WINDOW_3440	2560
			// 2007-07-14 by dgwoo
