...
DWORD GetFontColor( char chr )
{
	...
	case GM_FONT:
		return (HFONT_ARGB(0x00,(BYTE)170,(BYTE)255,(BYTE)0));
	case RED_FONT:
...
/// \return		
///////////////////////////////////////////////////////////////////////////////
BOOL StringCullingUserDataEx(char *pLineString, int nCullStringNum, vector<string> *vecStorage, CD3DHanFont* pHanFont, BOOL bChRt /*= FALSE*/)
{
